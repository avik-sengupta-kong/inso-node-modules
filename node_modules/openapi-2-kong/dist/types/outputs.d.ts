...
export declare type ConversionResultType = 'kong-declarative-config' | 'kong-for-kubernetes';
...
export declare type ConversionResult = DeclarativeConfigResult | KongForKubernetesResult;
