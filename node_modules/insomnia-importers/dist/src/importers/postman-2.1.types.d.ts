 ...
 */
export declare type NameOfTheCollection = string;
/**
 * A Description can be a raw text, or be an object, which holds the description along with its format.
 */
export declare type DefinitionsDescription = Description | string | null;
/**
 ...
 */
export declare type CollectionVersion = {
    /**
...
export declare type Items = Item | Folder;
/**
 ...
 */
export declare type Variable = Variable1 & Variable2;
export declare type Variable1 = {
    [k: string]: unknown;
} | {
    [k: string]: unknown;
} | {
 ...
 */
export declare type VariableList = Variable[];
/**
 ...
 */
export declare type Host = string | string[];
/**
 ...
 */
export declare type ResponseTime = null | string | number;
/**
 * Set of timing information related to request and response in milliseconds
 */
export declare type ResponseTimings = {
    [k: string]: unknown;
} | null;
export declare type Headers = Header1 | string | null;
export declare type Header2 = string;
/**
 ...
 */
export declare type Header1 = (Header | Header2)[];
export declare type Responses = Response[];
export declare type Items1 = Item | Folder;
...
//# sourceMappingURL=postman-2.1.types.d.ts.map