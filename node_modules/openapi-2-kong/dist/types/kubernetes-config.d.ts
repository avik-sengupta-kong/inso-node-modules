...
export declare type K8sAnnotations = K8sIngressClassAnnotation & K8sOverrideAnnotation & K8sPluginsAnnotation & Record<string, string>;
...
export declare type K8sKongPlugin = K8sKongPluginBase<Plugin>;
export declare type K8sManifest = K8sIngress | K8sKongIngress | K8sKongPlugin;
//# sourceMappingURL=kubernetes-config.d.ts.map